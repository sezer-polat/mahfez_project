...
function ToursContent() {
  ...
  return (
    <div className="min-h-screen py-8 md:py-12 bg-background mt-16">
      <div className="w-full max-w-screen-xl mx-auto px-2 sm:px-4">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            {/* Tour Cards */}
            <div className={`grid ${viewMode === 'grid' ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8' : 'grid-cols-1 gap-6'}`}>
